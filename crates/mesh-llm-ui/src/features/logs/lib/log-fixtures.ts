...
export function generateLifecycleEvents(requestIdStr: string): readonly LogLifecycleEvent[] {
  ...
  const events: LogLifecycleEvent[] = [
    { eventId:eventUuid(requestIdStr, 1), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.createdAt) - 0), kind:'admitted', model:undefined, provider:undefined, engine:undefined, attemptId:undefined, statusCode:undefined, durationMs:undefined, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 2), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.createdAt) - 0), kind:'route_selected', model:fixture.model, provider: fixture.provider ?? 'local-native', engine: undefined, attemptId:undefined, statusCode:undefined, durationMs:undefined, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 3), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.createdAt) - 0), kind:'attempt_started', model: fixture.model, provider: undefined, engine: fixture.engine ?? 'native', attemptId:'att-1', statusCode:undefined, durationMs:undefined, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 4), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt)), kind:'stream_started', model: fixture.model, provider: undefined, engine: undefined, attemptId:'att-1', statusCode:undefined, durationMs:undefined, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 5), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:'stream_chunk', model: undefined, provider: undefined, engine: undefined, attemptId:'att-1', statusCode:undefined, durationMs:undefined, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 6), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:'stream_completed', model: undefined, provider: undefined, engine: undefined, attemptId:'att-1', statusCode:undefined, durationMs:250, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 7), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:'attempt_completed', model: undefined, provider: undefined, engine: fixture.engine ?? 'native', attemptId:'att-1', statusCode: fixture.statusCode, durationMs:250, tokens:undefined },
    { eventId:eventUuid(requestIdStr, 8), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:(fixture.outcome as LogLifecycleEvent['kind']), model: undefined, provider: undefined, engine:undefined, attemptId:'att-1', statusCode: fixture.statusCode ?? 200, durationMs:300, tokens:undefined },
  ]

  if (fixture.outcome === 'failed') {
    events[5] = { eventId:eventUuid(requestIdStr, 6), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:'stream_error', model:undefined, provider:undefined, engine:undefined, attemptId:'att-1', statusCode: fixture.statusCode ?? 502, durationMs: undefined, tokens: undefined }
    events[6] = { eventId:eventUuid(requestIdStr, 7), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:'attempt_failed', model:undefined, provider:undefined, engine:(fixture.engine ?? 'native'), attemptId:'att-1', statusCode: fixture.statusCode ?? 502, durationMs: undefined, tokens: undefined }
    events[7] = { eventId:eventUuid(requestIdStr, 8), requestId:fixture.requestId, occurredAt:ts(minutesSince(fixture.terminalAt) - 0), kind:'audit_error', model:undefined, provider:undefined, engine:undefined, attemptId:'att-1', statusCode:(fixture.statusCode ?? 502), durationMs: undefined, tokens: undefined }
  }
